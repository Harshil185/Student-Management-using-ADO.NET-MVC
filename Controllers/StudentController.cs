using Practical_Assignment_2.Models;
using System;
...
namespace Practical_Assignment_2.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult Index(string departmentFilter)
        {
            ...
            {
                List<StudentModel> students = sdb.GetStudentByDepartment(departmentFilter); // Modify this method in your StudentDBHandle
        ...
        // POST: Student/Edit/5
        [HttpPost]
        public ActionResult Edit(int Stud_ID, StudentModel student)
        {
            try
            {
