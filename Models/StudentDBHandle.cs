...
namespace Practical_Assignment_2.Models
{
    public class StudentDBHandle
    {
        ...
        {
            string constring = ConfigurationManager.ConnectionStrings["StudentMVC"].ToString();
        ...
        public List<StudentModel> GetStudentByDepartment(string departmentId)
        {
            connection();
            List<StudentModel> studentlist = new List<StudentModel>();
